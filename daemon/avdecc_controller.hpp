...
public:
    ...
    // Called when entity list changes (add/remove/name change).
    void setOnChangeCallback(OnChangeCallback cb) { _onChange = std::move(cb); }
...
private:
    ...
    la::avdecc::controller::Controller::UniquePointer _controller{nullptr, [](la::avdecc::controller::Controller*){}};
    mutable std::mutex _mutex;
    std::unordered_map<uint64_t, EntityRecord> _entities;
